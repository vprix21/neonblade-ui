...
const propsMap: Record<string, PropDefinition[]> = {
  ...
  badge: [
    ...
    },
    {
      ...
      default: '"outline"',
      description:
        'Visual style. "solid" fills with accent color, "outline" shows a border with transparent background, "ghost" uses a subtle tinted background.',
    },
    {
      name: "shape",
    ...
    },
    {
      ...
      default: '"bottom-right"',
      description:
        "Which corner is cut. Only applies when shape is corner-cut.",
    },
    {
      name: "cornerSize",
      type: "number",
