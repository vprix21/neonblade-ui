...
import { GridScene } from "../../../lib/components/ui/backgrounds/GridScene";
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <button
        ...
        style={{
          background: value ? accentColor + "55" : "transparent",
          borderColor: value ? accentColor : "#ffffff22",
        }}
      >
        <span
          className="absolute top-0.5 w-3 h-3 rounded-full transition-all"
          style={{
            background: value ? accentColor : "#ffffff44",
...
/* ── page ───────────────────────────────────────────────────────────────── */
export default function GridSceneDemoPage() {
    ...
    <div className="min-h-screen bg-[#050505] text-white font-orbitron overflow-x-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-6 gap-8 overflow-hidden select-none">
        <GridScene
          ...
          showFloor={ctrl.showFloor}
          showCeiling={ctrl.showCeiling}
        />

        {/* back button */}
        <div className="absolute top-[100px] left-6 z-20">
          <Link href="/components/backgrounds/grid-scene">
            <CornerCutButton
              size="xs"
              variant="outline"
              color={accent}
        ...
        >
          ...
          >
            ...
            >
              <ToggleRow
                label="Show Floor"
                value={ctrl.showFloor}
                accentColor={accent}
                onChange={(v) => set("showFloor", v)}
              />
              <ToggleRow
                label="Show Ceiling"
                value={ctrl.showCeiling}
                accentColor={accent}
                onChange={(v) => set("showCeiling", v)}
              />
            </div>
          </div>
        </div>
