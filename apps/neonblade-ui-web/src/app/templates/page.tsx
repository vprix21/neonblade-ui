...
const templates = [
  {
    ...
    description:
      "A fully customizable SaaS analytics console: sidebar navigation, KPI cards, neon charts, sortable data tables and form-driven settings. Built end-to-end with NeonBlade UI.",
    tags: ["Dashboard", "SaaS", "Analytics", "Admin"],
    tech: ["Next.js", "TypeScript", "Tailwind CSS", "Recharts"],
    color: "cyan" as const,
    status: "free" as const,
    github: "https://github.com/vprix21/nexus-dashboard-template",
    preview: "https://nexus-dashboard-template-blond.vercel.app/",
  },
  {
                ...
                >
                  ...
                  <div className="mt-4 pt-3 border-t border-white/10 flex items-center gap-3">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-3 py-1.5 rounded text-xs font-medium text-white/70 hover:text-white border border-white/10 hover:border-white/30 transition-colors"
                    >
                      {t.github ? "Preview" : "Open live demo →"}
                    </a>
                  </div>
                </NeonGlowCornerCutCard>
              </div>
