    ...
    <>
      <div className="md:hidden flex items-center justify-start gap-4 mb-8 border-b border-white/10 pb-4">
        <button
          ...
          className="p-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded corner-cut text-white transition-colors flex-shrink-0"
          aria-label="Open menu"
        >
          <Menu className="w-5 h-5 text-[#00f3ff]" />
        </button>
        <h2 className="text-xl font-orbitron font-bold text-white">Components</h2>
      </div>
        ...
        <div className="fixed inset-0 z-[100] flex">
          ...
          <div className="relative w-3/4 max-w-sm h-full bg-[#050505] border-r border-[#00f3ff]/30 shadow-[4px_0_24px_rgba(0,243,255,0.1)] p-6 flex flex-col overflow-hidden animate-in slide-in-from-left duration-300">
            <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-4">
              ...
              >
                <X className="w-5 h-5 text-[#ff00ff]" />
              </button>
            </div>
            ...
            <div className="pt-6 mt-auto border-t border-white/10">
              <div className="flex gap-4">
                <Link href="/" onClick={() => setIsOpen(false)} className="text-sm font-orbitron text-white/50 hover:text-[#00f3ff] transition-colors">Home</Link>
                <Link href="/docs" onClick={() => setIsOpen(false)} className="text-sm font-orbitron text-white/50 hover:text-[#ff00ff] transition-colors">Documentation</Link>
              </div>
            </div>
          </div>
        </div>
